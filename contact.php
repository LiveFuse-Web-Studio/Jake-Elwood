...
$address = "intouch@livefuse.co.za";
...
$e_subject = 'Aether submission by ' . $name . '.';
...
$e_body = "Form submission by $name from Aether" . PHP_EOL . PHP_EOL;
$e_content = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name by email, $email";
